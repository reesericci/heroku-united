...
ActiveRecord::Schema[7.2].define(version: 2024_07_07_022552) do
  ...
  create_table "keyrings", id: false, force: :cascade do |t|
    t.text "id"
    t.string "type"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["id"], name: "index_keyrings_on_id", unique: true
  end
  ...
  create_table "passkeys", id: false, force: :cascade do |t|
    t.text "id"
    t.string "name"
    t.text "keyring_id"
    t.text "public_key"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["id"], name: "index_passkeys_on_id", unique: true
  end
  ...
  create_table "verifications", force: :cascade do |t|
    ...
    t.string "verifiable_id", null: false
    t.boolean "verified", default: true, null: false
    t.datetime "verified_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["verifiable_type", "verifiable_id"], name: "index_verifications_on_verifiable"
  end
